...
## Feature Bullets
- One-tap Focus Mode toggle with instant YouTube cleanup
- Removes home feed, comments, related videos, Shorts, Explore, Trending, and notification distractions
- Clean fullscreen focus state on blocked pages
- Lock Mode keeps Focus Mode enabled for 25, 50, 90, or custom-minute sessions
- Light and dark popup themes with a minimal premium interface
